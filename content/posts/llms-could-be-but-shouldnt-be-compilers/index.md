...
semantics as a vector in C++ even when the underlying implementation differs wildly across languages and runtimes.
...
It’s been true for a long time that specifying a piece of software is often harder than building it. But we may be entering a world where: if you can specify, you can build. If that’s right, then [specification and verification become the bottleneck](https://alperenkeles.com/posts/verifiability-is-the-limit/), and therefore the core skill.
